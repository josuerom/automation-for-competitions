...
def generadorRondaRPCWindows():
   ronda = input("\033[93mRonda del año ->\033[0m ")
   ruta_base_rpc = f"c:\\workspace\\contests\\rpc"
   ...
   ruta_descargas = r"c:\users\admin\downloads"
   ...
   tem_cpp = r"c:\workspace\util\templates\tem_rpc.cpp"
   tem_java = r"c:\workspace\util\templates\tem.java"
   tem_py = r"c:\workspace\util\templates\tem.py"
