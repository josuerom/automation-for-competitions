...
def generadorRondaRPCWindows():
   ...
   tem_cpp = f"d:\\workspace\\contests\\util\\templates\\tem_2bits.cpp"
   tem_java = f"d:\\workspace\\contests\\util\\templates\\template.java"
   tem_py = f"d:\\workspace\\contests\\util\\templates\\template.py"
