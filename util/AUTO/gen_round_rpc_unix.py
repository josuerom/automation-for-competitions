...
def generadorRondaRPCUnix():
   ...
   ruta_base_rpc = f"/home/josuerom/Workspace/contests/RPC"
   ...
   tem_cpp = f"/home/josuerom/Workspace/contests/util/TEMPLATES/tem_2bits.cpp"
   tem_java = f"/home/josuerom/Workspace/contests/util/TEMPLATES/template.java"
   tem_py = f"/home/josuerom/Workspace/contests/util/TEMPLATES/template.py"

   lista_id = input("\033[93mQué problemas intentará resolver. Ej: [A B] ->\033[0m ").upper().split()
